...
2.  set global user name and user email for all repository/git folders (if you want to set different username and email for different git repository then remove --global)
    - set global user name: `git config --global user.name "mimtiazahmed20"`
    - set global user email: `git config --global user.email "mimtiazahmed20@gmail.com"`
...
### Lesson 10. Connecting local repo to remote repo
...
### Lesson 12. branching and merging
...
### [Lesson 13. 2-way and 3-way merges]()
